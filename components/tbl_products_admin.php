<!-- product_id,category_id,owner_user_id,prod_name,prod_buying_price,prod_selling_price,prod_quantity,prod_units_of_measure,prod_description
 -->          <div class="col-md-12">
            <div class="card">
              <div class="card-header card-header-primary">
                <h4 class="card-title text-center" style="text-transform: uppercase;">Admin Product Listing</h4>
                    ...
                    <tbody>
                      ...
                      require_once('./php/dbcon.php');
                        ...
                        while($row=mysqli_fetch_array($result)){
                           ...
                           $prod_descriptio =$row['prod_description']; 
                        ?>
                        <tr>
                              <td>
                                <?php echo $product_id; ?>
